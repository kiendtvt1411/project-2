...
package dhbkhn.kien.doan2.data.network.model;
...
public class LoginResponse {
    ...
    public int hashCode() {
        ...
        result = 69 * result + (userId != null ? userId.hashCode() : 0);
        result = 69 * result + (accessToken != null ? accessToken.hashCode() : 0);
        result = 69 * result + (userName != null ? userName.hashCode() : 0);
        result = 69 * result + (userEmail != null ? userEmail.hashCode() : 0);
        result = 69 * result + (serverProfilePicUrl != null ? serverProfilePicUrl.hashCode() : 0);
        result = 69 * result + (fbProfilePicUrl != null ? fbProfilePicUrl.hashCode() : 0);
        result = 69 * result + (googleProfilePicUrl != null ? googleProfilePicUrl.hashCode() : 0);
        result = 69 * result + (message != null ? message.hashCode() : 0);
        return result;
    }
}
