...
public class EspOne {
    ...
    @Generated(hash = 1949563425)
    public EspOne() {
    }

    @Generated(hash = 1680506519)
    public EspOne(Long id, boolean lampOne, boolean lampTwo, boolean lampThree, float temperature, float humidity, float maxTempurature, float maxHumidity, String date) {
        this.id = id;
